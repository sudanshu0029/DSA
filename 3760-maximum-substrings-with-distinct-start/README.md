<h2><a href="https://leetcode.com/problems/remove-vowels-from-a-string/description/">4087. Maximum Substrings With Distinct Start</a></h2><h3>Medium</h3><hr><p>You are given a string <code>s</code> consisting of lowercase English letters.</p>
